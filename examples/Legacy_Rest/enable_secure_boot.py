...
def enable_secure_boot(restobj, secure_boot_enable, bios_password=None):
    ...
    response = restobj.patch(secure_boot_path, body)
...
if __name__ == "__main__":
    ...
    enable_secure_boot(REST_OBJ, False)
    REST_OBJ.logout()