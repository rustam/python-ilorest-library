...
def set_bios_service(restobj, bios_properties, bios_password=None):
    ...
    response = restobj.patch(bios_path, bios_properties, bios_password)
...
if __name__ == "__main__":
    ...
    set_bios_service(REST_OBJ, {'ServiceName':'HPE', 'ServiceEmail':'me@hpe.com'})
    REST_OBJ.logout()
