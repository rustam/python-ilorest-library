...
def set_bios_dhcp(restobj, bios_properties, bios_password=None):
    ...
    response = restobj.patch(bios_path, bios_properties)
...
if __name__ == "__main__":
    ...
    REST_OBJ.login()
    sys.stdout.write("\nEXAMPLE 32: Set DHCP\n")
    set_bios_dhcp(REST_OBJ, {'Ipv4Address':'192.168.0.1', \
